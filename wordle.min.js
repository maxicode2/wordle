this.wordle = this.wordle || {}, this.wordle.bundle = function(e) {
    ...
    function y(e, a) {
        return function(e) {
            ...
            var t, n, o = [],
                ...
                i = false;
            try {
                for (s = s.call(e); !(r = (t = s.next()).done) && (o.push(t.value), !a || o.length !== a); r = true);
            } catch (e) {
                i = true, n = e
            } finally {
                try {
    ...
    var v = function(e) {
        ...
        function t() {
            var e;
            return s(this, t), o(m(e = a.call(this)), "_letter", ""), o(m(e), "_state", "empty"), o(m(e), "_animation", "idle"), o(m(e), "_last", false), o(m(e), "_reveal", false), e.attachShadow({
                mode: "open"
            }), e
        }
        return n(t, [{
    ...
    var j = "nyt-wordle-darkmode",
        ...
        C = function(e) {
            ...
            function t() {
                var e;
                s(this, t), o(m(e = a.call(this)), "isDarkTheme", false), o(m(e), "isColorBlindTheme", false), e.attachShadow({
                    mode: "open"
                });
                var n = JSON.parse(window.localStorage.getItem(j)),
                    r = window.matchMedia("(prefers-color-scheme: dark)").matches,
                    i = JSON.parse(window.localStorage.getItem(S));
                return true === n || false === n ? e.setDarkTheme(n) : r && e.setDarkTheme(true), true !== i && false !== i || e.setColorBlindTheme(i), window.themeManager = m(e), e
            }
            return n(t, [{
                key: "setDarkTheme",
                value: function(e) {
    ...
    L.prototype.clear = function() {
        ...
        var a = this.__data__,
            s = _(a, e);
        return !(s < 0) && (s == a.length - 1 ? a.pop() : q.call(a, s, 1), --this.size, true)
        ...
        if (d) me(e, s, d);
            ...
            if (m) {
                ...
                u = l, p || h || y ? Me(i) ? u = i : _e(c = i) && Re(c) ? u = function(e, a) {
                    ...
                    return a
                }(i) : h ? (m = false, u = function(e, a) {
                    if (a) return e.slice();
                    var s = e.length,
                        t = fe ? fe(s) : new e.constructor(s);
                    return e.copy(t), t
                }(l, true)) : y ? (m = false, u = ve(l, true)) : u = [] : function(e) {
                    if (!_e(e) || "[object Object]" != D(e)) return false;
                    var a = Se(e);
    ...
    var Ta = function(e) {
        ...
        return n(t, [{
            ...
            value: function() {
                var e = this;
                this.shadowRoot.appendChild(La.content.cloneNode(true)), this.shadowRoot.querySelector("#puzzle-number").textContent = "#".concat(this.gameApp.dayOffset), this.shadowRoot.addEventListener("game-switch-change", (function(a) {
                    a.stopPropagation();
                    var s = a.detail,
                        t = s.name,
                        n = s.checked,
    ...
    var Ia = function(e) {
        ...
        return n(t, [{
            ...
            value: function() {
                var e = this;
                this.shadowRoot.appendChild(Aa.content.cloneNode(true));
    ...
    function getDailySolution(e) {
        var a, s = getDailyGameString(e);
        return a = s % Ma.length, Ma[a]
    }

    function getDailyGameString(e) {
        return Ga(Ba, e)
    }
    ...
    function as() {
        return Ka || (Ka = setInterval((function() {
            es.getItem(Qa) && (es.removeItem(Qa), window.location.reload(true))
        }), 43200000))
    }
    ...
    var ls = "IN_PROGRESS",
        ...
        ms = function(e) {
            ...
            function t() {
                var e;
                s(this, t), o(m(e = a.call(this)), "tileIndex", 0), o(m(e), "rowIndex", 0), o(m(e), "solution", void 0), o(m(e), "boardState", void 0), o(m(e), "evaluations", void 0), o(m(e), "canInput", true), o(m(e), "gameStatus", ls), o(m(e), "letterEvaluations", {}), o(m(e), "$board", void 0), o(m(e), "$keyboard", void 0), o(m(e), "$game", void 0), o(m(e), "today", void 0), o(m(e), "lastPlayedTs", void 0), o(m(e), "lastCompletedTs", void 0), o(m(e), "hardMode", void 0), o(m(e), "dayOffset", void 0), e.attachShadow({
                    mode: "open"
                ...
                var daily = !e.lastPlayedTs || Ga(new Date(e.lastPlayedTs), e.today) >= 1;
                var newGame = n.gameStatus !== "IN_PROGRESS" && (daily || (/^#(?:\d+|[a-zA-Z]{5})$/g).test(window.location.hash))
                ...
                if(newGame) {
                    ...
                    if(daily) {
                        e.solution = getDailySolution(e.today)
                        e.dayOffset = getDailyGameString(e.today)
                    }
                    else if((/^#[a-zA-Z]{5}$/g).test(window.location.hash)) {
                        var word = window.location.hash.substring(1).toLowerCase();
                        console.log(word)
                        var shuf=(char,amt)=>String.fromCharCode(word.charCodeAt(char)+amt);
                        e.solution = shuf(3, -1)+shuf(1, -1)+shuf(2, -1)+shuf(0, -1)+shuf(4, -1);
                        e.dayOffset = window.location.hash.toUpperCase();
                    }
                    else {
                        e.dayOffset = parseInt(window.location.hash.substring(1))
                        e.solution = Ma[e.dayOffset % Ma.length]
                    }
                    console.log(e.dayOffset)
                    ...
                    e.lastCompletedTs = n.lastCompletedTs
                    e.hardMode = n.hardMode
                    if(e.gameStatus !== ls) e.canInput = false
            ...
            return n(t, [{
                ...
                value: function() {
                    if (5 === this.tileIndex && !(this.rowIndex >= 6)) {
                        ...
                        var r = function(e, a) {
                            for (var s = Array(a.length).fill(Na), t = Array(a.length).fill(true), n = Array(a.length).fill(true), o = 0; o < e.length; o++) e[o] === a[o] && n[o] && (s[o] = Ha, t[o] = false, n[o] = false);
                        ...
                        if (i || l) Za({
                            isWin: l,
                            isStreak: !!this.lastCompletedTs && 1 === Ga(new Date(this.lastCompletedTs), new Date),
                            numGuesses: this.rowIndex
                        }), updateLocalStorage({
                            lastCompletedTs: Date.now()
                        }), this.gameStatus = l ? ds : cs, es.setItem(Qa, true);
                        this.tileIndex = 0, this.canInput = false, updateLocalStorage({
                ...
                value: function() {
                    ...
                    this.shadowRoot.getElementById("new-game-button").onclick = () => this.shadowRoot.getElementById("statistics-button").click()
                    this.$game = this.shadowRoot.querySelector("#game"), this.$board = this.shadowRoot.querySelector("#board"), this.$keyboard = this.shadowRoot.querySelector("game-keyboard"), this.sizeBoard(), this.lastPlayedTs || setTimeout((function() {
                    ...
                    this.$game.addEventListener("game-key-press", (function(e) {
                            ...
                            d.$keyboard.letterEvaluations = d.letterEvaluations, d.rowIndex < 6 && (d.canInput = true);
                            ...
                            (e.path || e.composedPath && e.composedPath()).includes(a) && ([ds, cs].includes(d.gameStatus) && (d.restoringFromLocalStorage ? d.showStatsModal() : (d.gameStatus === ds && (a.setAttribute("win", ""), d.addToast(us[d.rowIndex - 1], 2e3)), d.gameStatus === cs && d.addToast(d.solution.toUpperCase(), 1 / 0), setTimeout((function() {
                                d.showStatsModal()
                            }), 2500))), d.restoringFromLocalStorage = false)
                            ...
                            switch (s) {
                                case "hard-mode":
                                    return void(n ? d.addToast("Hard mode can only be enabled at the start of a round", 1500, true) : (d.hardMode = t, updateLocalStorage({
                                        hardMode: t
                                    })))
                            }
                ...
                value: function() {
                    var e = this;
                    this.shadowRoot.getElementById("debug-tools").appendChild(is.content.cloneNode(true)), this.shadowRoot.getElementById("toast").addEventListener("click", (function(a) {
    ...
    var hs = function(e) {
        ...
        return n(t, [{
            ...
            value: function() {
                var e = this;
                this.shadowRoot.appendChild(ps.content.cloneNode(true)), this.addEventListener("click", (function(a) {
    ...
    var fs = [
        ...
        ks = function(e) {
            ...
            return n(t, [{
                ...
                value: function() {
                    var e = this;
                    this.shadowRoot.appendChild(ys.content.cloneNode(true)), this.$keyboard = this.shadowRoot.getElementById("keyboard"), this.$keyboard.addEventListener("click", (function(a) {
                        ...
                        s.classList.add("row"), a.forEach((function(e) {
                            var a;
                            if (e >= "a" && e <= "z" || "←" === e || "↵" === e) {
                                if ((a = gs.content.cloneNode(true).firstElementChild).dataset.key = e, a.textContent = e, "←" === e) {
                            ...
                            } else(a = bs.content.cloneNode(true).firstElementChild).classList.add(1 === e.length ? "half" : "one");
                            s.appendChild(a)
    ...
    function As(e, a, s) {
        for (var t in e.success = true, a) {
            var n = a[t],
                o = s.clipboardData;
            o.setData(t, n), "text/plain" === t && o.getData(t) !== n && (e.success = false)
        }
        s.preventDefault()
    }
        ...
        return vs(this, void 0, void 0, (function() {
            ...
            return ws(this, (function(s) {
                if (a = "text/plain" in e, "undefined" == typeof ClipboardEvent && void 0 !== Ls.clipboardData && void 0 !== Ls.clipboardData.setData) {
                    ...
                    if (t = e["text/plain"], Ls.clipboardData.setData("Text", t)) return [2, true];
    ...
    var Ps = document.getElementById("end-modal-template");
    var $s = document.getElementById("end-modal-statistics-template");
    var Ds = document.getElementById("end-modal-guess-distribution-template");
    var Bs = document.getElementById("end-modal-footer-template");
            ...
            return n(t, [{
                ...
                value: function() {
                    ...
                    if (["gamesPlayed", "winPercentage", "currentStreak", "maxStreak"].forEach((function(s) {
                            var t = Gs[s],
                                n = e.stats[s],
                                o = $s.content.cloneNode(true);
                            o.querySelector(".label").textContent = t, o.querySelector(".statistic").textContent = n, a.appendChild(o)
                        })), this.gameApp.gameStatus !== ls) {
                        var endModalFooter = this.shadowRoot.querySelector(".footer"),
                            p = Bs.content.cloneNode(true);
                        endModalFooter.appendChild(p), this.shadowRoot.querySelector("button#share-button").addEventListener("click", (function(a) {
    ...
    var Ys = function(e) {
        ...
        return n(t, [{
            key: "connectedCallback",
            value: function() {
                this.shadowRoot.appendChild(Fs.content.cloneNode(true))
            }
        }]), t
    }(u(HTMLElement));
    ...
    var Js = function(e) {
        ...
        return n(t, [{
            ...
            value: function() {
                var e = this;
                this.shadowRoot.appendChild(Us.content.cloneNode(true)), this.addEventListener("click", (function(a) {
    ...
    var Zs = function(e) {
        ...
        return n(t, [{
            ...
            value: function() {
                var e = this;
                this.shadowRoot.appendChild(Xs.content.cloneNode(true)), this.shadowRoot.querySelector(".container").addEventListener("click", (function(a) {
    ...
    var Qs = function(e) {
        ...
        return n(t, [{
            key: "connectedCallback",
            value: function() {
                this.shadowRoot.appendChild(Ks.content.cloneNode(true))
            }
        }]), t
    }(u(HTMLElement));
    ...
    var at = function(e) {
        ...
        return n(t, [{
            ...
            value: function() {
                var e = this;
                this.shadowRoot.appendChild(et.content.cloneNode(true)), this.shadowRoot.querySelector("game-icon").addEventListener("click", (function(a) {
    ...
    var tt = {
            ...
            new: "M10.875 1.125v9.5h-9.5v2.25h9.5v9.5h2.25v-9.5h9.5v-2.25h-9.5v-9.5",
            newCustom: "M10.375,0v10.375h-10.375v2.25h10.375v10.375l2.25,-2.25v-8.125h8.125l2.25-2.25h-10.375v-10.375z M22.84,16.28l-0.71,0.71l-2.12-2.12l0.71-0.71c0.39-0.39,1.02-0.39,1.41,0l0.71,0.71C23.23,15.26,23.23,15.89,22.84,16.28z M19.3,15.58l2.12,2.12l-5.3,5.3H14v-2.12L19.3,15.58z",
            statistics: "M16,11V3H8v6H2v12h20V11H16z M10,5h4v14h-4V5z M4,11h4v8H4V11z M20,19h-4v-6h4V19z",
            next: "M6.23,20.23L8,22L18,12L8,2L6.23,3.77L14.46,12z"
        },
        nt = function(e) {
            r(t, e);
            var a = h(t);
            ...
            return n(t, [{
                key: "connectedCallback",
                value: function() {
                    this.shadowRoot.appendChild(st.content.cloneNode(true));
    ...
    var rt = function(e) {
        ...
        return n(t, [{
            key: "connectedCallback",
            value: function() {
                this.shadowRoot.appendChild(ot.content.cloneNode(true))
            }
        }]), t
    }(u(HTMLElement));
    ...
    var lt = function(e) {
        ...
        return n(t, [{
            key: "connectedCallback",
            value: function() {
                this.shadowRoot.appendChild(it.content.cloneNode(true))
            }
        }]), t
    }(u(HTMLElement));
    ...
    var ct = 6e4,
        ...
        mt = function(e) {
            ...
            return n(t, [{
                ...
                value: function() {
                    var e = this;
                    this.shadowRoot.appendChild(dt.content.cloneNode(true)), this.$timer = this.shadowRoot.querySelector("#timer"), this.intervalId = setInterval((function() {
                        e.updateTimer()
                    }), 200)
                }
            }, {
